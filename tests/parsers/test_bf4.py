...
""")
    ...
    def test_getAvailableServerMaps(self):
        ...
        when(self.parser).write(('maplist.availableMaps', 'perMap')).thenReturn(
            ['MP_Resort', 'RL0', 'CQS0', 'XP4_WlkrFtry', 'CQL0', 'TDM0', 'OBL', 'XP2_003', 'RL0', 'XP0_Caspian', 'SDM0', 'SDM3', 'DOM0', 'ELI0']
        )
        self.assertDictEqual({'MP_Resort': ['RushLarge0', 'ConquestSmall0'],
                              'XP0_Caspian': ['SquadDeathMatch0', 'Domination0', 'Elimination0'],
                              'XP2_003': ['RushLarge0'],
                              'XP4_WlkrFtry': ['ConquestLarge0', 'TeamDeathMatch0', 'Obliteration']
                              }, self.parser.getAvailableServerMaps())
